...
pencox_res <- pencox(eventvar, X, gamma = 0.1, alpha = 0.3, lambda = 0, maxiter = 800, standardise = TRUE)
pencox_res
...
glmnet_res <- coef(glmnet(x = X2 ,y = y, family = 'cox', alpha = 0.3, lambda = 0,standardize = FALSE))
glmnet_res
